...
hl.bind(mainMod .. " + M", hl.dsp.exec_cmd(programs.sessionMenu))
...
hl.bind("Print",         hl.dsp.exec_cmd(programs.screenshotRegion))
hl.bind("SHIFT + Print", hl.dsp.exec_cmd(programs.screenshotFull))
